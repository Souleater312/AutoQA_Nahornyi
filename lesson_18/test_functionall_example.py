...
from lesson_15.len_dict_example import Company
...
@pytest.mark.regression
def test_building_len_populated_builing(populated_builing):
    assert len(populated_builing) == 2
